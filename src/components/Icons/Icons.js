...
const PeopleIcon = ({ className, width = '3.2rem', height = '3.2rem' }) => {
    return (
        <>
            <svg
                className={className}
...
const PeopleActiveIcon = ({ className, width = '3.2rem', height = '3.2rem' }) => {
    return (
        <>
            <svg
                className={className}
...
const CompassIcon = ({ className, width = '3.2rem', height = '3.2rem' }) => {
    return (
        <>
            <svg
                className={className}
...
const CompassActiveIcon = ({ className, width = '3.2rem', height = '3.2rem' }) => {
    return (
        <>
            <svg
                className={className}
...
const CameraIcon = ({ className, width = '3.2rem', height = '3.2rem' }) => {
    return (
        <>
            <svg
                className={className}
...
const CameraActiveIcon = ({ className, width = '3.2rem', height = '3.2rem' }) => {
    return (
        <>
            <svg
                className={className}
